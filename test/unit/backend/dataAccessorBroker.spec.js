...
describe('data access broker tests', () => {
    ...
    describe('when put todo', () => {
        ...
        test('it should call put', () => {
            ...
            expect(put).toHaveBeenCalledWith('https://api.xilution.com/elements-data-accessor-beta/things', {
                ...request.body,
                '@type': 'todo',
    ...
    describe('when get todo', () => {
        ...
        test('it should call get', () => {
            ...
            expect(get).toHaveBeenCalledWith(`https://api.xilution.com/elements-data-accessor-beta/things/${request.parameters.id}`, typeAwareOptions);
        });
    });
    ...
    describe('when delete todo', () => {
        ...
        test('it should call del', () => {
            ...
            expect(del).toHaveBeenCalledWith(`https://api.xilution.com/elements-data-accessor-beta/things/${request.parameters.id}`, typeAwareOptions);
        });
    });
    ...
    describe('when fetching todos', () => {
        ...
        test('it should call get', () => {
            expect(get).toHaveBeenCalledTimes(1);
            expect(get).toHaveBeenCalledWith(`https://api.xilution.com/elements-data-accessor-beta/things?search-criteria-id=${searchCriteriaId}&page-number=${startPage}&page-size=${pageSize}`, typeAwareOptions);
        });
    });
    ...
    describe('when put type', () => {
        ...
        test('it should call put', () => {
            expect(put).toHaveBeenCalledTimes(1);
            expect(put).toHaveBeenCalledWith(`https://api.xilution.com/elements-data-accessor-beta/types/${request.parameters.name}`, request.body, authorizedOptions);
        });
    });
});
